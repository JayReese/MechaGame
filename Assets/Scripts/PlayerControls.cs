...
public class PlayerControls : MonoBehaviour
{
    ...
    private void CheckActionControls()
    {
        ...
        if (PlayerReference.PlayerID == PlayerInput.CurrentPlayerID /*PlayerReference.PlayerID == 0*/ && PlayerReference.CurrentInterfacingState == InterfacingState.CONTROLLABLE)
        {
